...
/// <summary>
///     A utility class that provides extension methods for configuring and setting up the application's services and
///     middleware.
/// </summary>
    ...
    public static void AddSwagger(this IServiceCollection services)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            options.SwaggerDoc(apiVersion, new OpenApiInfo
            {
                ...
                Description = "AnswerService api v1",
                //maybe add in future
                //TermsOfService = termsOfServiceUrl,
                Contact = new OpenApiContact
                {
                    Name = "AnswerService api contact"
                    //maybe add in future
