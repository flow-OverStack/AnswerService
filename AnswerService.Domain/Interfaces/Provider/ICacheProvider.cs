namespace AnswerService.Domain.Interfaces.Provider;
...
public interface ICacheProvider
{
    ...
    ///     The optional time-to-live (in seconds) for the keys being added. If set to zero or
    ///     negative, no expiration is applied.
    /// </param>
