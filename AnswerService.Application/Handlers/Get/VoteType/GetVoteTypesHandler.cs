...
public class GetVoteTypesHandler(IBaseRepository<Domain.Entities.VoteType> voteTypeRepository)
    : IRequestHandler<GetVoteTypesCommand, CollectionResult<Domain.Entities.VoteType>>
{
    public async Task<CollectionResult<Domain.Entities.VoteType>> Handle(GetVoteTypesCommand request,
